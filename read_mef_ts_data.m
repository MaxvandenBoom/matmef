...
%                         Default is 'samples'.
%       rangeStart      = Start-point for the reading of data. Can either be an epoch/unix timestamp or (0-based) sample-index
%                         Pass -1 to start at the beginning or first sample of the timeseries. Default is -1, beginning/first
%       rangeEnd        = End-point to stop the of reading data. Either as an epoch/unix timestamp or (0-based) sample-index
