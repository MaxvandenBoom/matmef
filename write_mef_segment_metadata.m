...
%       passwordL1   = Segment metadata level 1 password; Pass empty string/variable if not encrypted
%       passwordL2   = Segment metadata level 2 password; Pass empty string/variable if not encrypted
